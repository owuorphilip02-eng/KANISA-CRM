...
$today      = strtoupper(date('j F Y'));
$logoUrl    = SystemURLs::getRootPath() . '/Images/logo-churchcrm-350.png';
?>

<!-- Church Header Banner -->
<div class="d-flex align-items-center justify-content-center py-3 mb-3 border-bottom gap-3">
    <img src="<?= $logoUrl ?>" alt="Church Logo"
         style="height:80px; width:auto; object-fit:contain; flex-shrink:0;">
    <div class="text-center">
        <div class="fw-bold fs-3 text-uppercase"><?= htmlspecialchars($churchName) ?></div>
        <div class="fs-5 text-body-secondary"><?= htmlspecialchars($diocese) ?></div>
        <div class="fw-semibold fs-6 mt-1"><?= $today ?></div>
    </div>
</div>   
 ...
 <!-- Stat Cards Row -->
    <div class="row row-cards mb-3 g-2">
        ...
        <div class="col-6 col-md-4 col-lg">
            <a href="<?= $sRootPath ?>/finance" class="card card-sm text-decoration-none">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                        ...
                        <div class="col">
                            <div class="fw-medium text-body"><?= gettext('Finance') ?></div>
                            <div class="text-body-secondary"><?= gettext('Donations & Deposits') ?></div>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-6 col-md-4 col-lg">
            <a href="<?= $sRootPath ?>/inventory" class="card card-sm text-decoration-none">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                        ...
                        <div class="col">
                            <div class="fw-medium text-body"><?= gettext('Inventory') ?></div>
                            <div class="text-body-secondary"><?= gettext('Assets & Stock') ?></div>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="card-title">
                        <i class="ti ti-users me-2 text-body-secondary"></i><?= gettext('Members') ?>
                    </div>
